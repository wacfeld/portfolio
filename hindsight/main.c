...
// TODO implement regex for -p or don't, i don't really want to
// TODO add a -g graph option, or if i'm not that bold, an -e export option, for spreadsheet friendly totals
// TODO add -P to exclude certain patterns
// TODO add graphical day summary, but that will require a new way of reading the file, to remember the range details
